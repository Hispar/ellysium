...
class KingdomFrontAppConfig(AppConfig):
    name = "kingdom_front"
    verbose_name = "Kingdom Frontend"
    label = "kingdom_front"

    provides = {
        "front_urls": [
            "kingdom_front.urls:urlpatterns"
        ],
        ...
        "front_model_url_resolver": [
            "kingdom_front.utils.urls.model_url"
        ]
    }
...
default_app_config = "kingdom_front.KingdomFrontAppConfig"
